...
/* Generated from ../O.Common/picoctl.dbd */
...
static const char * const recordTypeNames[] = {
    ...
    "stringin", "stringout", "sub", "subArray", "transform", "waveform"
};
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devPMNC87xx, *pvar_dset_devPrintfSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "devMotorAsyn", "devPMNC87xx", "devPrintfSoft",
...
epicsShareExtern drvet *pvar_drvet_drvAsyn, *pvar_drvet_drvPMNC87xx;
...
epicsShareExtern reg_func pvar_func_NewFocusRegister,
    ...
    pvar_func_iocshSystemCommand, pvar_func_motorRegister,
    pvar_func_motorUtilRegister, pvar_func_nf874xMotorRegister,
...
int picoctl_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/epics/iocs/pico93";
...
static const iocshFuncDef rrddFuncDef =
    {"picoctl_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    picoctl_registerRecordDeviceDriver(*iocshPpdbbase);
}
