...
static const char * const deviceSupportNames[86] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[86] = {
...
int picoctl_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    registerDevices(pbase, 86, deviceSupportNames, devsl);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"picoctl_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
